...
> # ⚠️ Перед чтением этого файла — прочти [CLAUDE.md](CLAUDE.md).
> Там правило №1: **в git-tracked файлы НЕ пишем личное** (компания владельца,
> имя, клиенты, конкретные проекты-заказчики). Репо публичный.
