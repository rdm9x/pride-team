...
# реальному Bitrix24 компании через skill bitrix24-pride и выгрузил
# production-задачи сотрудников. Devboard — изолированный канбан.
...
- НИКОГДА не подключайся к внешним системам: Bitrix24, любой CRM, к
  example-сервисам, к skill bitrix24-pride / order-orchestrator / любым
  бизнес-скиллам. Они НЕ твой инструмент — игнорируй даже если видишь в списке.
