---
тип: карта_репозитория_для_агентов_расширенная
проект: devboard
версия: v1.6
обновлено: 2026-05-24
---

# AGENTS_EXTENDED.md — полная карта репозитория Devboard

> Расширенная версия AGENTS.md. Читай когда нужны детали по конкретному модулю.
> Базовое: см. `/AGENTS.md` (core, 70 строк).
...
| `/api/departments` | GET | Список отделов |
| `/api/departments/<id>` | GET | Детали отдела |
...
### 14 MCP-tools (имена в Claude после префикса `mcp__devboard-tasks__`)
...
**Этот файл — живой**. Синхронизируй с `AGENTS.md` (core) при добавлении новых ключевых файлов/папок.
