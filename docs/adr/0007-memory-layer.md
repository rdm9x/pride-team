...
- Помнит специфику ПРАЙД — продукты (наружная реклама, POS), клиентов (клиент, клиент, клиент, Магнит, клиент), особенности производства.
...
|---|---|---|
| `note` | Структурные факты | «Owner — Дмитрий owner, директор ПРАЙД, наружная реклама и POS, Москва» |
