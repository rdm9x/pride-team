...
Проект здесь интерпретируется как **project-slug** (например `landing-roofing-2026`, `marketing-site-v2`). В контексте v2.0 с отделами, проект часто охватывает задачи из **нескольких отделов** (маркетинг + разработка + юристы на один лендинг).
...
!/workspace/dev/
!/workspace/marketing/
!/workspace/roofing-company/
!/workspace/roofing-company/landing.html  # пример E2E теста
```
...
def register_task_artifact(
    ...
    Args:
        ...
        file_path: Относительный путь файла внутри workspace/.
                   Пример: 'workspace/landing-roofing-2026/a1b2c3d4e5f6/landing.html'
...
```json
{
  "status": "opened",
  "file_path": "workspace/landing-roofing-2026/a1b2c3d4e5f6/landing.html",
  "absolute_path": "/Users/dm_pc/Desktop/pride-team-v1.0/workspace/landing-roofing-2026/a1b2c3d4e5f6/landing.html",
...
```
POST /api/tasks/a1b2c3d4e5f6/artifacts?project_slug=landing-roofing-2026
